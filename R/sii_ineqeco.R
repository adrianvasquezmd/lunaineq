#' Slope Index of Inequality for Ecological Data
#'
#' @description
#' Estimates the slope index of inequality for ecological data from ecological data using a
...
#'
#' @details
#' The estimand is `SII = Y_advantaged - Y_disadvantaged`.
#'
...
sii_ineqeco <- function(
  ...
  if (length(extra_args) > 0) {
    ...
    stop(
      "Unsupported argument(s) supplied to `sii_ineqeco()`: ",
